...
{ echo "<button class='btn btn-success' ><i class='fa fa-plus-square'></i> ".$namatombol."</button>"; };
...
{ echo "<button class='btn btn-warning' ><i class='fa fa-refresh'></i> ".$namatombol."</button>"; };
