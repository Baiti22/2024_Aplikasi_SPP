...
?>
	...
	<table width="100%" class="tblcms2">
		<tr>
			...
			<th class="th_border cell">id&nbsp;spp</th>
			<th class="th_border cell">nominal</th>
		...
		<tbody>
			...
			if (isset($_GET['isi']) && !empty($_GET['isi'])) {
				...
				$querytabel = "SELECT * FROM data_spp where $Berdasarkan like '%$isi%'";
				...
				$querytabel = "SELECT * FROM data_spp where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
			} else {
				//SEMUA
				$querytabel = "SELECT * FROM data_spp";
			}
