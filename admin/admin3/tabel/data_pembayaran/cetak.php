	...
	<table width="100%" class="tblcms2">
		...
		<tbody>
			...
			if (isset($_GET['isi']) && !empty($_GET['isi'])) {
				...
				$querytabel = "SELECT * FROM data_pembayaran where $Berdasarkan like '%$isi%'";
				...
				$querytabel = "SELECT * FROM data_pembayaran where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
			} else {
				//SEMUA
				$querytabel = "SELECT * FROM data_pembayaran";
			}
