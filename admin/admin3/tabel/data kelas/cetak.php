...
<?php
	...
	proses_action_cetak("data_kelas");
?>
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
	...
	<table width="100%" class="tblcms2">
		<tr>
			...
			<th class="th_border cell">id&nbsp;kelas</th>
			<th class="th_border cell">nama kelas</th>
			<th class="th_border cell">kompetensi keahlian</th>
		...
		<tbody>
			...
			if (isset($_GET['isi']) && !empty($_GET['isi'])) {
				...
				$querytabel = "SELECT * FROM data_kelas where $Berdasarkan like '%$isi%'";
				...
				$querytabel = "SELECT * FROM data_kelas where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
			} else {
				//SEMUA
				$querytabel = "SELECT * FROM data_kelas";
			}
