<body>
	...
	<a target="blank" href="cetak.php?berdasarkan=data_petugas&jenis=xls&pakaiperperiode=<?php echo $status_pakaiperperiode; ?>">
		<?php btn_export('Export Excel'); ?>
	</a>

	<a target="blank" href="cetak.php?berdasarkan=data_petugas&jenis=print&pakaiperperiode=<?php echo $status_pakaiperperiode; ?>">
		<?php btn_cetak('Cetak'); ?>
	</a>
	...
	<div style="overflow-x:auto;">
		<table <?php tabel(100, '%', 1, 'left');  ?>>
			<tr>
				...
				<th align="center" class="th_border cell">Level</th>
